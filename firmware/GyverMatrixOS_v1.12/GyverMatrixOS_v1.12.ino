...
#define WIDTH 45              // ширина матрицы
...
#define IDLE_TIME 15          // время бездействия кнопок или Bluetooth (в секундах) после которого запускается автосмена режимов и демо в играх
...
#define MODES_AMOUNT 32   // количество кастомных режимов (которые переключаются сами или кнопкой)
...
int8_t specialTextEffectParam = -1;
uint8_t effectScaleParam[MODES_AMOUNT];      // Динамический параметр эффекта, параметр #1
uint8_t effectScaleParam2[MODES_AMOUNT];     // Динамический параметр эффекта, параметр #2
uint8_t effectContrast[MODES_AMOUNT];
uint8_t  effectSpeed[MODES_AMOUNT];
